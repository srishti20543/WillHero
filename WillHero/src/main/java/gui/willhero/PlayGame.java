...
//            helmet.setLayoutY(helmet.getLayoutY() + playerDy);
//
//            Node n = checkCollisionIsland();
//
//            if(prev == null){
//                prev = rec1;
//            }
...
//            }
//
//            if(helmet.getLayoutY() <= prev.getLayoutY() - 100){
//                playerDy = -playerDy;
//            }
//        });
//
...
//            helmet.setLayoutX(helmet.getLayoutX() + playerDx);
//            if(checkCollisionIsland() != null){
//                helmet.setLayoutX(helmet.getLayoutX() - playerDx);
...
//    */
//
//    private Node checkCollisionIsland(){
